...
**Быстрые ссылки:**
- 🔌 **[Настройка Tuya Smart Plugs](docs/TUYA_USER_GUIDE.md)** ⚡ НОВОЕ - управление питанием через Smart Life
- 🏠 **[Настройка Home Assistant](docs/HOME_ASSISTANT_USER_GUIDE.md)** ⚡ НОВОЕ - для всех брендов розеток (Tuya, Яндекс и т.д.)
