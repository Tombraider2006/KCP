...
![3D Printer Control Panel](https://img.shields.io/badge/Версия-1.5.2-blue.svg)
...
- 📖 [**Полная инструкция по настройке Bambu Lab**](BAMBU_LAB_SETUP_RU.md)
...
📖 **Подробная инструкция**: [BAMBU_LAB_SETUP_RU.md](BAMBU_LAB_SETUP_RU.md)
...
- **📈 Детальная информация** о каждом принтере:
  - 🌡️ **Умные температурные датчики** с визуальными предупреждениями
  - 🌡️ **Гибкая настройка датчиков температуры** (кнопка 🌡️)
  - 📊 **Прогресс печати увеличенным шрифтом** - виден издалека на большом мониторе
  - 📁 Имя текущего файла
  - 🔄 Состояние печати
  - ⏰ Время последнего обновления
- **📲 Телеграм бот** - важные уведомления в вашем телефоне!
...
### 📱 Интерфейс и UX
- **📱 Адаптивный дизайн** для компьютеров и мониторов любого размера
- **🔢 Умная динамическая сортировка** принтеров по приоритету
- **📋 Система логов** с экспортом и очисткой
- **🪟 Модальные окна** для настройки
- **⌨️ Поддержка горячих клавиш** (Enter для подтверждения)
- **🌍 Мультиязычность** - автоматическое определение русского/английского

### 📈 Аналитика и мониторинг (для руководителей)
- **📊 Профессиональные графики Chart.js** - интерактивные визуализации
- **⚡ Энергопотребление** - подробный расчёт потребления электроэнергии
- **💰 Стоимость энергии** - автоматический расчёт затрат на электричество
- **📈 Эффективность работы** - анализ времени печати vs простоя
- **⏱️ Периоды неэффективности** - отслеживание пауз и простоев с комментариями операторов
- **📊 Отчёты по операторам** - почему были простои, кто виноват
- **🗑️ Управление данными** - очистка устаревших данных
- **📖 Справочник по расчёту мощности** - инструкция для настройки
...
### 🆕 v1.4.0 (Текущая версия) - Smart Temperature Monitoring
...
- **⚙️ Автоматическое обнаружение датчиков** - полный список из Moonraker API
- **🎨 Продвинутая настройка** - выбор конкретных датчиков с custom названиями
- **🌍 Полная локализация** - все интерфейсы переведены
- **🐛 Исправления** - улучшена стабильность работы
...
- **💰 Точные расчёты** - правильный подсчёт энергопотребления
...
- 📖 Подробнее: [BAMBU_LAB_SETUP_RU.md](BAMBU_LAB_SETUP_RU.md)
...
- 📖 [Настройка Bambu Lab](BAMBU_LAB_SETUP_RU.md)
