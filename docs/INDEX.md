...
### По теме:
- **Настройка умных розеток Tuya:** → [TUYA_USER_GUIDE.md](TUYA_USER_GUIDE.md) 🔌 **НОВОЕ**
- **Настройка Home Assistant:** → [HOME_ASSISTANT_USER_GUIDE.md](HOME_ASSISTANT_USER_GUIDE.md) 🏠 **НОВОЕ**
...
- **Всего файлов:** 30+ (добавлено 9+ файлов по Smart Plugs)
- **Языки:** Русский, English
- **Категории:** 7 (Основная, Bambu Lab, Analytics, Development, Releases, Research, Smart Plugs)
- **Общий объем:** ~15000+ строк актуальной документации

---

**Последнее обновление:** 11.10.2025  
**Версия структуры:** 2.0 (добавлена секция Smart Plugs)
