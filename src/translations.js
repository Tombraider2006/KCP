...
const TRANSLATIONS = {
    ru: {
        ...
        'scan_hint': 'Быстрое сканирование проверяет часто используемые IP (~150), Полное сканирование проверяет всю подсеть (~250)',
    ...
    en: {
        ...
        'full_scan': '🌐 Full Scan',
        'scan_hint': 'Quick scan checks common IP addresses (~150), Full scan checks entire subnet (~250)',
