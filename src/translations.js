...
const TRANSLATIONS = {
    ru: {
        ...
        'access_code_hint': 'Получите в настройках принтера → Сеть → Код доступа',
        ...
        // Printer Management
        'manage_printers': 'Управление принтерами',
        'add_manage_printers': '🔧 Добавление и управление принтерами',
        'add_manually': 'Добавить вручную',
        'add_manually_hint': '➕ Добавить по IP',
        'start_scan': 'Сканировать',
        'scan_hint': '🔍 Найти в сети',
        'import_btn': 'Импорт',
        'import_hint': '📥 Восстановить резервную копию',
        'export_btn': 'Экспорт',
        'export_hint': '📤 Сохранить конфигурацию',
        'scanning_network': 'Сканирование сети...',
        'found_printers': 'Найдено принтеров',
        'no_printers_found': 'Принтеры не найдены в сети',
        'scan_tip': 'Убедитесь, что принтеры включены и подключены к той же сети',
        'scan_started': 'Сканирование сети запущено',
        'scan_complete': 'Сканирование завершено',
        'printers_found': 'принтер(ов) найдено',
        'scan_error': 'Ошибка сканирования',
        'scan_no_results': '🔍 В сети не найдено принтеров',
        'scan_modal_opened': '🔍 Открыт сканер сети',
        'scan_already_running': '⚠️ Сканирование уже выполняется',
        'scan_not_available': '❌ Сканер сети недоступен',
        'already_added': 'уже добавлен',
        'requires_credentials': 'требуется код доступа и серийный номер',
        'printer_info_filled': 'Информация о принтере заполнена из результатов сканирования',
        'add': 'Добавить',
        'close': 'Закрыть',
        
        // Batch add and export/import
        'batch_add_selected': 'Добавить выбранные',
        'batch_add_all': 'Добавить все',
        'export_printers': '📤 Экспорт принтеров',
        'import_printers': '📥 Импорт принтеров',
        'printers_exported': 'Принтеры экспортированы',
        'printers_imported': 'Принтеры импортированы',
        'import_error': 'Ошибка импорта',
        'export_import_hint': 'Экспорт/импорт конфигурации принтеров для резервного копирования или переноса на другой компьютер',
        'select_all': 'Выбрать все',
        'deselect_all': 'Снять выбор',
        'selected_count': 'Выбрано',
        'batch_add_success': 'Принтеры добавлены',
        'no_printers_selected': 'Принтеры не выбраны',
        'import_file_invalid': 'Неверный формат файла',
        'duplicate_name_suffix': '(копия)',
        ...
        // Web Server
        'web_server_btn_text': 'Web-сервер',
        'web_server_modal_title': 'Настройки Web-сервера',
        'web_server_port_label': 'Порт сервера:',
        'web_server_port_hint': 'Рекомендуется: 8000-9000',
        'web_server_status_checking': 'Проверка...',
        'web_server_status_running': '✅ Запущен',
        'web_server_status_stopped': '⭕ Остановлен',
        'web_server_url_text': 'Web-интерфейс доступен по адресу:',
        'web_server_clients_text': 'Подключенных клиентов:',
        'web_server_what_is_it_title': 'Что это?',
        'web_server_what_is_it_text': 'Web-сервер позволяет управлять принтерами через браузер с любого устройства в вашей локальной сети. Просто откройте указанный адрес на компьютере, планшете или телефоне.',
        'web_server_feature1': 'Просмотр статуса всех принтеров',
        'web_server_feature2': 'Мониторинг в реальном времени',
        'web_server_feature3': 'Доступ с любого устройства в сети',
        'web_server_feature4': 'Не требует установки',
        'web_server_btn_start': '▶️ Запустить',
        'web_server_btn_stop': '🛑 Остановить',
        'web_server_btn_processing': 'Обработка...',
        'web_server_btn_open': 'Открыть в браузере',
        'web_server_btn_help': '📖 Помощь',
        'web_server_btn_close': 'Закрыть',
    ...
    en: {
        ...
        'add_manage_printers': '🔧 Add & Manage Printers',
        'add_manually': 'Add Manually',
        'add_manually_hint': '➕ Add printer by IP',
        'start_scan': 'Scan Network',
        'scan_hint': '🔍 Find in network',
        'import_btn': 'Import',
        'import_hint': '📥 Restore backup',
        'export_btn': 'Export',
        'export_hint': '📤 Save config',
        'scanning_network': 'Scanning network...',
        'found_printers': 'Found Printers',
        'no_printers_found': 'No printers found on the network',
        'scan_tip': 'Make sure printers are powered on and connected to the same network',
        'scan_started': 'Network scan started',
        'scan_complete': 'Scan complete',
        'printers_found': 'printer(s) found',
        'scan_error': 'Scan error',
        'scan_no_results': '🔍 No printers found on the network',
        'scan_modal_opened': '🔍 Network scanner opened',
        'scan_already_running': '⚠️ Scan is already in progress',
        'scan_not_available': '❌ Network scanner is not available',
        'already_added': 'already added',
        'requires_credentials': 'requires access code & serial',
        'printer_info_filled': 'Printer information filled from scan',
        'add': 'Add',
        'close': 'Close',
        
        // Batch add and export/import
        'batch_add_selected': 'Add Selected',
        'batch_add_all': 'Add All',
        'export_printers': '📤 Export Printers',
        'import_printers': '📥 Import Printers',
        'printers_exported': 'Printers exported',
        'printers_imported': 'Printers imported',
        'import_error': 'Import error',
        'export_import_hint': 'Export/import printer configurations for backup or transfer to another computer',
        'select_all': 'Select All',
        'deselect_all': 'Deselect All',
        'selected_count': 'Selected',
        'batch_add_success': 'Printers added',
        'no_printers_selected': 'No printers selected',
        'import_file_invalid': 'Invalid file format',
        ...
        // Web Server
        'web_server_btn_text': 'Web Server',
        'web_server_modal_title': 'Web Server Settings',
        'web_server_port_label': 'Server Port:',
        'web_server_port_hint': 'Recommended: 8000-9000',
        'web_server_status_checking': 'Checking...',
        'web_server_status_running': '✅ Running',
        'web_server_status_stopped': '⭕ Stopped',
        'web_server_url_text': 'Web interface is available at:',
        'web_server_clients_text': 'Connected clients:',
        'web_server_what_is_it_title': 'What is this?',
        'web_server_what_is_it_text': 'Web server allows you to manage printers through a browser from any device on your local network. Just open the address on your computer, tablet or phone.',
        'web_server_feature1': 'View status of all printers',
        'web_server_feature2': 'Real-time monitoring',
        'web_server_feature3': 'Access from any device on network',
        'web_server_feature4': 'No installation required',
        'web_server_btn_start': '▶️ Start',
        'web_server_btn_stop': '🛑 Stop',
        'web_server_btn_processing': 'Processing...',
        'web_server_btn_open': 'Open in Browser',
        'web_server_btn_help': '📖 Help',
        'web_server_btn_close': 'Close',
